        ...
        <ul>
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="rating.rateType===0 ? 'icon-dianzan_leave':'icon-tucao-tianchong'"></span>
  ...
  export default {
    ...
    data(){
      return{
        ...
        selectType:2 //评价的选择类型，0 满意、 1 不满意 、2 全部
      }
    },
    computed:{
